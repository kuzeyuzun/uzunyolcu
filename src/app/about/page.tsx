export default function AboutPage() {
  return (
    <section className="max-w-2xl mx-auto">
      ...
      <p className="mb-4">
        UzunYolcu’nun kurucusu <b>Kuzey Seyda Uzun</b>, yazılım geliştirici ve dijital içerik üreticisi. 
      ...
      <div className="mb-3">
        <a href="https://www.linkedin.com/comm/mynetwork/discovery-see-all?usecase=PEOPLE_FOLLOWS&followMember=kuzeyseydauzun" className="text-sky-400 hover:underline" target="_blank" rel="noopener">
          LinkedIn'de beni takip edin
        </a>
      </div>
      <p>Her türlü öneri ve iletişim için: <a href="mailto:info@uzunyolcu.com" className="text-sky-400 hover:underline">info@uzunyolcu.com</a></p>
    </section>
  );
}